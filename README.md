...
✅ A hero section with high-quality visuals and call-to-action

🍽️ Menu and specials section with tasteful imagery

🧩 Animated scroll effects using ScrollReveal.js

🎨 Custom typography and color palette with Google Fonts

📱 Mobile-first design for a seamless experience across devices

🖼️ Organized image assets and clean folder structure
